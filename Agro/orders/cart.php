                        ...
                        <div class="d-flex align-items-center border p-2">
                            ...
                            <div class="col-auto flex-shrink-1 flex-grow-1">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="col-auto px-0 flex-shrink-1 flex-grow-1"><p class="m-0 pl-3"><small class="text-primary"><?= format_num($prow['price']) ?> tk</small></p></div>
                                </div>
                                <div class="d-flex">
                            ...
                            <div class="col-3 text-right"><?= format_num($total) ?> tk</div>
                        </div>
                        <?php endwhile; ?>
                    </div>
                    <div class="col-12 border">
                        <div class="d-flex">
                            ...
                            <div class="col-3 text-right font-weight-bold"><?= format_num($vtotal) ?> tk</div>
                        </div>
                    </div>
                <?php endwhile; ?>
                    <div class="col-12 border">
                        <div class="d-flex">
                            ...
                            <div class="col-3 h4 font-weight-bold text-right"><?= format_num($gtotal) ?> tk</div>
                        </div>
                    </div>
                </div>
            </div>
