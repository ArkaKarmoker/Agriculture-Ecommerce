        ...
        <div class="card-body">
            ...
            <form id="vlogin-frm" action="" method="post">
                <div class="input-group mb-3">
                    <input type="text" class="form-control" name="username" autofocus placeholder="Username" id="username">
...
<script>
    $(function () {
        ...
        // Retrieve the vendor email from the cookie and autofill the form
        const vendorEmail = getCookie('vendor_email');
        if (vendorEmail) {
            $('#username').val(vendorEmail);
        }
            ...
            $.ajax({
                ...
                success: function (resp) {
                    if (typeof resp == 'object' && resp.status == 'success') {
                        // Set the email cookie on successful login
                        document.cookie = "vendor_email=" + $('input[name="username"]').val() + "; path=/; max-age=86400"; // expires in 1 day
